...
public static class GameEvents
{
    ...
    public static void RaiseSceneLoadRequested(string sceneName)
    {
    ...
    public static void RaiseQuitRequested()
    {
        OnQuitRequested?.Invoke();
    }

    public static void RaiseLevelLoadRequested(string levelId)
    {
        OnLevelLoadRequested?.Invoke(levelId);
    }

    public static void RaiseLevelLoaded(string levelId)
    {
